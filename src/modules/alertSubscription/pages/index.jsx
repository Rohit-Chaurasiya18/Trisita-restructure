...
const AlertSubscription = () => {
  ...
  const {
    ...
    alertSubscriptionLastUpdated:
      state?.alertSubscription?.alertSubscriptionLastUpdated,
  ...
  const handleFetchData = async () => {
    const { rorFilter, startDate } = filters;
  ...
  useEffect(() => {
    handleFetchData();
  }, [filter?.csn, debounce, filters?.rorFilter]);
  ...
  const renderLimitedText = (value) => <div>{value}</div>;
  ...
  useEffect(() => {
    let data = handleFilter(alertSubscriptionList);
  ...
  useEffect(() => {
    if (
      ...
      setFilteredData(alertSubscriptionList);
    }
  }, [
    filters?.account,
    filters?.branch,
        ...
        <div className="subscription-header">
          ...
          <div className="subscription-filter">
            <Tooltip
              title={
                alertSubscriptionLastUpdated
                  ? moment(alertSubscriptionLastUpdated).format(
