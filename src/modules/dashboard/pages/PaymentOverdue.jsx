...
const PaymentOverdue = () => {
  ...
  useEffect(() => {
    setFilteredData(paymentOverdueList);
  }, [paymentOverdueList]);
  ...
  useEffect(() => {
    let filteredList = paymentOverdueList;
  ...
  return (
    <>
      <div className="renewal-email-sent-header mb-4">
        <div>
          <h3 className="mb-0 commom-header-title">Payment Overdue</h3>
          <span className="common-breadcrum-msg">
            Welcome to your Payment Overdue
          </span>
        </div>
        <div className="subscription-filter">
          <CommonAutocomplete
            ...
            loading={branchListLoading || paymentOverdueListLoading}
