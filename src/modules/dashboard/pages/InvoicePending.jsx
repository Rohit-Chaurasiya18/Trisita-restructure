...
import { GetInvoicePendingList, getOrderLoadingPo, updateLockUnlockStatus } from "../slice";
import { useEffect, useState } from "react";
import { Tooltip } from "@mui/material";
import { FaLock, FaUnlock } from "react-icons/fa";
import CommonTable from "@/components/common/dataTable/CommonTable";
import CommonModal from "@/components/common/modal/CommonModal";
import OrderLoadingHoDetails from "../components/OrderLoadingHoDetails";
...
const InvoicePending = () => {
  ...
  useEffect(() => {
    setFilteredData(invoicePendingList);
  }, [invoicePendingList]);
  ...
  useEffect(() => {
    let filteredList = invoicePendingList;
  ...
  return (
    <>
      <div className="renewal-email-sent-header mb-4">
        <div>
          <h3 className="mb-0 commom-header-title">Invoice Pending</h3>
          <span className="common-breadcrum-msg">
            Welcome to your Invoice Pending
          </span>
        </div>
        <div className="subscription-filter">
          <CommonAutocomplete
            ...
            loading={branchListLoading || invoicePendingListLoading}
