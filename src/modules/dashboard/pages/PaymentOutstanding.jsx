...
const PaymentOutstanding = () => {
  ...
  useEffect(() => {
    setFilteredData(paymentOutstandingList);
  }, [paymentOutstandingList]);
  ...
  useEffect(() => {
    let filteredList = paymentOutstandingList;
  ...
  return (
    <>
      <div className="renewal-email-sent-header mb-4">
        <div>
          <h3 className="mb-0 commom-header-title">Payment Outstanding</h3>
          <span className="common-breadcrum-msg">
            Welcome to your Payment Outstanding
          </span>
        </div>
        <div className="subscription-filter">
          <CommonAutocomplete
            ...
            loading={branchListLoading || paymentOutstandingListLoading}
