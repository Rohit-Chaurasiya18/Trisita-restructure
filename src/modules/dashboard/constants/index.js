  ...
  series: [
    {
      name: "Seats",
      data: [
        105, 2, 1, 1, 7, 3, 2, 221, 10, 3, 14, 960, 20, 5, 1, 1, 14, 100, 33,
        167, 2, 7, 2, 90, 13, 4, 78, 24, 48, 51, 160, 10, 7, 70, 10, 7, 1, 2, 6,
        3, 1, 2, 2, 1, 1, 10, 75, 4, 7, 3, 1, 20, 2, 1, 4, 3, 1, 5, 1, 4, 7, 4,
        3, 2, 1, 2, 1, 1, 1, 250, 2, 500, 1, 3, 1, 7, 3, 14, 2, 3, 9, 17, 2, 11,
        8, 3, 1, 1, 4, 5, 3, 19, 5, 30, 1, 1, 19, 3, 5, 1, 4, 9, 3, 1, 20, 1,
        64, 60, 3, 10, 7, 12, 1, 10, 1, 1, 2, 2, 3, 9, 1, 1, 4, 7, 9, 3, 4, 3,
        23, 5, 54, 7, 1, 9, 9, 50, 1, 12, 15, 6, 33, 3, 2, 40, 26, 1, 1, 2, 25,
        3, 30, 1, 2, 50, 2, 9999, 25, 110, 9, 1, 3, 8, 4, 13, 3, 10, 6, 1, 3, 1,
        4, 1, 30, 41, 4,
      ],
    },
  ],
};
export const ColoumnCharts = {
  options: {
    chart: {
      type: "bar",
      height: 350,
  ...
  series: [
    {
      name: "Mumbai",
      data: [
        9999, 1873, 792, 571, 521, 228, 104, 47, 7, 4, 3, 3, 3, 2, 2, 2, 2, 1,
        1, 1,
      ],
    },
  ],
